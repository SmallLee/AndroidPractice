...
public class TimeUtil {
     ...
     * yyyy.MM.dd HH:mm
     */
    public final static SimpleDateFormat YMD_HM_POINT = new SimpleDateFormat("yyyy.MM.dd HH:mm");
     ...
     * @return 年.月.日 时:分
     */
    public static String parserTimePointYMDHM(String time) {
        return parseTime(YMD_HM_POINT, parseToLong(time));
    }
     ...
     * @return 年.月.日 时:分
     */
    public static String parserTimePointYMDHM2(String time) {
        return parseTime2(YMD_HM_POINT, parseToLong(time));
    }
     ...
     * @return 年.月.日 时:分
     */
    public static String parserTimeYMDHM3(String time) {
        return parseTime(YMD_HM_POINT, parseToLong(time));
    }
    ...
    public static String parseTime2(SimpleDateFormat format, long time) {
    ...
    private static long parseToLong2(String strValue) {
        return parseToLong(strValue, (long) 0);
    }
