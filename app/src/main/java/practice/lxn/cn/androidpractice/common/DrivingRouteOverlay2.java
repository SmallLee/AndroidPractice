 ...
 */
public class DrivingRouteOverlay2 extends OverlayManager {
     ...
     */
    public DrivingRouteOverlay2(BaiduMap baiduMap) {
        super(baiduMap);
    }
...
//            }
            ...
            BitmapDescriptor route = BitmapDescriptorFactory.fromAsset("icon_road_gray_arrow.png");
            PolylineOptions option = new PolylineOptions().points(points)
                    .width(18).dottedLine(true)
                    .customTexture(route).zIndex(0);
            if (isDotLine) {
